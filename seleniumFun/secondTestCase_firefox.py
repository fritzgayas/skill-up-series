...
options = Options()
options.set_preference("dom.webdriver.enabled", True)  # (Optional) useful for avoiding detection
# options.add_argument("-headless")  # Uncomment to run Firefox in headless mode
